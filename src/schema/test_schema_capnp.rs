...
pub mod network {
  ...
  pub mod get_status_results {
    ...
    impl <'a,> Reader<'a,>  {
      ...
      #[inline]
      pub fn get_status(self) -> ::capnp::Result<crate::test_schema_capnp::status::Reader<'a>> {
    ...
    impl <'a,> Builder<'a,>  {
      ...
      #[inline]
      pub fn get_status(self) -> ::capnp::Result<crate::test_schema_capnp::status::Builder<'a>> {
        ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0))
      }
      #[inline]
      pub fn set_status<'b>(&mut self, value: crate::test_schema_capnp::status::Reader<'b>) -> ::capnp::Result<()> {
        ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(0), value, false)
      }
      #[inline]
      pub fn init_status(self, ) -> crate::test_schema_capnp::status::Builder<'a> {
    ...
    impl Pipeline  {
      pub fn get_status(&self) -> crate::test_schema_capnp::status::Pipeline {
